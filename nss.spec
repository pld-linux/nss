# $Revision: 1.4 $ $Date: 2001-12-13 23:51:00 $
...
%description -l pl
NNS wspomaga pisanie wieloplatformowych bezpiecznych serwerСw.
Aplikacja u©ywaj╠ca NSS jest w stanie obsЁu©yФ PKCS #5, PKCS #7, 
PKCS #11, PKCS #12, S/MIME, TLS, SSL v2 oraz v3, certyfikaty X.509 v3, 
i wiele innych bezpiecznych standardСw.

%package devel
Summary:	NSS - header files
Summary(pl):	NSS - pliki nagЁСwkowe
...
CzЙ╤Ф biblioteki NSS przeznaczona dla programistСw.
